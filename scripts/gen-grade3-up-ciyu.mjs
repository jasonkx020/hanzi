/**
 * @file gen-grade3-up-ciyu.mjs
 * @module scripts
 * @description 源文件：gen-grade3-up-ciyu.mjs
...
const outPath = path.join(root, 'static', 'booktext', 'renjiaoban', renjiaoTextbookJsonFile(3, '上', 'words'))
