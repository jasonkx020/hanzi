/**
 * @file gen-grade4-down-literacy.mjs
 * @module scripts
 * @description 源文件：gen-grade4-down-literacy.mjs
...
const outPath = path.join(root, 'static', 'booktext', 'renjiaoban', renjiaoTextbookJsonFile(4, '下', 'literacy'))
