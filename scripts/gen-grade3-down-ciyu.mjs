/**
 * @file gen-grade3-down-ciyu.mjs
 * @module scripts
 * @description 源文件：gen-grade3-down-ciyu.mjs
...
const outPath = path.join(root, 'static', 'booktext', 'renjiaoban', renjiaoTextbookJsonFile(3, '下', 'words'))
