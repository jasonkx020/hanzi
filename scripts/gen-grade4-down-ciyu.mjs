/**
 * @file gen-grade4-down-ciyu.mjs
 * @module scripts
 * @description 源文件：gen-grade4-down-ciyu.mjs
...
const outPath = path.join(root, 'static', 'booktext', 'renjiaoban', renjiaoTextbookJsonFile(4, '下', 'words'))
