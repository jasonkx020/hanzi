/**
 * @file gen-grade4-up-writing.mjs
 * @module scripts
 * @description 源文件：gen-grade4-up-writing.mjs
...
const outPath = path.join(root, 'static', 'booktext', 'renjiaoban', renjiaoTextbookJsonFile(4, '上', 'writing'))
